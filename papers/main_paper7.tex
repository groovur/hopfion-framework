...
Because the director strain is pressureless and comoving with the
baryons, with no independent sound speed, it shifts no acoustic scale: the
standard $r_s\approx147\,\mathrm{Mpc}$ is preserved, with no golden-ratio
shift.  Whether the strain also supplies the full recombination-era matter
budget is tied to the ordering epoch of Section~\ref{P7:sec:dm_ic} and is
not settled here; the prediction of the sector is the absence of a shift,
not a modified scale.
...
as an input alongside $\TCMB$ and $m_e$; it is not derived here.
...
Standard baryon-acoustic scale $r_s\approx147\,\mathrm{Mpc}$ (director strain comoving with baryons) & \textcolor{darkgreen}{Consistent (Sec.~\ref{P7:sec:bao})} & $147\,\mathrm{Mpc}$ & no shift predicted \\[4pt]
...
radial-acceleration relation and shifting no acoustic scale, so the
standard $r_s\approx147\,\mathrm{Mpc}$ is preserved with no golden-ratio
shift.
