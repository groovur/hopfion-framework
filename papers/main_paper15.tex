...
Faddeev--Niemi Hopfion in the $\QH=2$ sector\footnote{Throughout, $\QH$
is the Hopf charge measured relative to the condensate ground state (the
$Q=2$ vacuum of Paper~I~\cite{Paper1}, Theorem~6.1);%\ref{P1:thm:vacuum}
$\QH=0$ is that ground state and $\QH=1,2,3$ are the neutrino,
charged-lepton, and baryon sectors.} reproduces, from
