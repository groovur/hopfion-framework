...
draft status) is inherited from the $\QH=2$ profile wall width,
consistent with the trefoil's geometry being set by the $\QH=2$
material from which it was assembled.
