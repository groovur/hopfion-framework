...
\begin{remark}[Consequence: no double-counting, but no shortcut
  either]
\label{P16:rem:no_doublecounting}
...
\end{remark}
\status{published}
\source{P16:rem:no_doublecounting}
...
\begin{remark}
\label{P16:rem:consistency_bound}
...
\end{remark}
\status{published}
\source{P16:rem:consistency_bound}
...
\end{remark}
\status{published}
\source{P15:rem:tube_separation}
...
\label{P15:rem:geometric_centre_vacuum}
...
\end{remark}
\status{published}
\source{P15:rem:geometric_centre_vacuum}
...
\label{P15:rem:qh2_vs_qh3_confinement}
...
\end{remark}
\status{published}
\source{P15:rem:qh2_vs_qh3_confinement}
...
\label{P15:rem:why_same_self_duality}
...
\end{remark}
\status{published}
\source{P15:rem:why_same_self_duality}
...
\label{P15:rem:thin_tube_relation}
...
\end{remark}
\status{published}
\source{P15:rem:thin_tube_relation}
...
\label{P15:rem:fusion_ratio_interp}
...
\end{remark}
\status{published}
\source{P15:rem:fusion_ratio_interp}
...
\begin{remark}
\label{P15:rem:fourth_root_phase}
...
\end{remark}
\status{published}
\source{P15:rem:fourth_root_phase}
...
\begin{remark}
\label{P15:rem:inverts_energy_ordering}
...
\end{remark}
\status{published}
\source{P15:rem:inverts_energy_ordering}
...
\begin{remark}[Physical interpretation]
\label{P15:rem:wrt_physical_interp}
...
\end{remark}
\status{published}
\source{P15:rem:wrt_physical_interp}
...
\begin{remark}
\label{P15:rem:three_conditions_summary}
...
The open problem of item~(iii) is a topology-preserving numerical saddle
finder that would confirm $C_3^*=2.5062$ directly
from the $\QH=3$ Euler--Lagrange profile.
\end{remark}
\status{published}
\source{P15:rem:three_conditions_summary}

\begin{remark}[The $\QH=2$ parallel]
\label{P15:rem:qh2_parallel}
...
sector's $\mathbb{Z}_2$ centre charge introduces a sign flip in the Cardy formula relative to $j=0$.
The physical condition is $|V^*|=\vp$, which both
$j=0$ ($V^*=+\vp$) and $j=\frac32$ ($V^*=-\vp$) satisfy.
\end{remark}
\status{published}
\source{P15:rem:sign_convention}
