...
\end{definition}
\status{published}
\source{P9:def:normed_division_algebra}
...
\end{remark}
\status{published}
\source{P9:rem:n_particle_prediction}
...
\end{remark}
\status{published}
\source{P9:rem:measurement_strength_observable}
...
\end{remark}
\status{published}
\source{P9:rem:stokes_connection}
...
\end{remark}
\status{published}
\source{P9:rem:structural_gap_projection}
...
\end{remark}
\status{published}
\source{P9:rem:geometric_interp_hh_cc}
...
\end{remark}
\status{published}
\source{P9:rem:feff_physical_origin}
...
\end{remark}
\status{published}
\source{P9:rem:angle_doubling_pointer}
