...
axisymmetric condensate (the \emph{effective} vacuum of the
$\twoI\to\twoT$ transition, not the condensate ground state) and the role
of the ``ordered phase'' by the
...
making the bare (unwound) trivial vacuum the global minimum; the soliton is only a
