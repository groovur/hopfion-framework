...
\label{P16:rem:double_role_proposition}
...
\end{remark}
\status{published}
\source{P16:rem:double_role_proposition}

\begin{remark}[Double role of this section's result]
\label{P16:rem:double_role_section}
...
\end{remark}
\status{published}
\source{P16:rem:double_role_section}
...
\label{P16:rem:architecture_justified}
...
\end{remark}
\status{published}
\source{P16:rem:architecture_justified}
\depends{strong/colour.tex (P16:thm:colour_exclusion)}
...
\label{P16:rem:colourshift_scope}
...
\end{remark}
\status{published}
\source{P16:rem:colourshift_scope}
...
\label{P16:rem:e8_negative_result}
...
\end{remark}
\status{published}
\source{P16:rem:e8_negative_result}
...
\begin{remark}[Why this result is still informative despite the null
  outcome]
\label{P16:rem:as_selfcons_informative}
...
\end{remark}
\status{published}
\source{P16:rem:as_selfcons_informative}
...
\label{P16:rem:onset_energy_scope}
...
\end{remark}
\status{published}
\source{P16:rem:onset_energy_scope}
