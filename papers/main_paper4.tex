...
\textbf{(v) Anti-screening and the running of $\alpha$.}
The four-term formula (Theorem~\ref{P4:thm:four_term_alpha}) predicts
$\aInv = 137.036\,00$ at the electron mass scale to $5\times10^{-7}\%$.  The $\mathrm{SU}(2)_3$ WZW
condensate is non-Abelian and exhibits anti-screening: virtual flux-knot
pairs in the condensate enhance the coupling at lower energies, reducing
$\aInv$ from $150.3$ toward $137.036$.  This is the analogue of asymptotic
freedom in QCD, applied to the electromagnetic coupling in the icosahedral
condensate background.  Above $m_e$, standard QED vacuum polarization
from $e^+e^-$, $\mu^+\mu^-$, and hadronic loops takes over, running
$\aInv$ to $\approx 128.9$ at the $Z$-boson scale, in agreement with
measurement (Section~\ref{P4:sec:alpha_running}).
...
to the WZW anti-screening that generated $\Delta_1$ and $\Delta_2$ in
the cascade of~\cite{Paper3} (see also Section~\ref{P4:sec:alpha_running}).
...
\end{tabular}
\end{center}
The alternating signs reflect the competition between two running mechanisms
operating simultaneously in opposite directions.

The dominant mechanism is \emph{WZW anti-screening}: the $\mathrm{SU}(2)_3$
condensate is non-Abelian and consequently asymptotically free, in exact
analogy with QCD.  Virtual flux-knot pairs in the condensate vacuum enhance
the coupling at lower energies, reducing $\aInv$ from the UV geometric value
$150.3$ toward the golden-angle attractor $360/\vp^2 = 137.508$.  This is the
same mechanism as asymptotic freedom in QCD, applied to the electromagnetic
coupling in the icosahedral condensate background.  The condensate breaks the
ordinary Abelian QED screening and replaces it with non-Abelian anti-screening;
the $-k/(2\pi)$ term is its exact one-loop coefficient~\cite{KZ1984}.
...
This runs the geometric UV value $\aInv_{\rm geo} = \vp^6/\sin^4(\pi/5)
= 150.3$ down to the golden-angle attractor $360/\vp^2 = 137.508$.
...
coupling at lower energies, reducing $\aInv$ from $150.3$ toward $137.036$.}
...
\midrule
$\Lambda_{\rm cond} \to m_e$ & WZW anti-screening & $150.3 \to 137.036$ (decreases) & Virtual flux-knot pairs \\
...
\noindent
Both columns show $\aInv$ decreasing, but for opposite physical reasons:
