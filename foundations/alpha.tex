...
topological transition (Theorem~\ref{P4:thm:second_spoke} of Paper~IV~\cite{Paper4});
$15/8-\vp$ is
...
the self-consistent fixed point $V(\bst)=\vp$ (Lemma~\ref{P4:lem:virial_factor}
...
the electron mass (Theorem~\ref{P4:thm:second_spoke},
Theorem~\ref{P4:thm:spoke_ground} of Paper~IV~\cite{Paper4}: two $Q_H{=}1$ quanta fusing to the
...
$4\pi+(15/8-\vp)$ approximately, or identify a different, genuinely
...
\end{remark}
\status{open (candidate, provably not exact)}
\source{P3:rem:delta1_candidate}
\residual{$0.0061\%$ numerical match; not an exact identity (algebraic vs.\ transcendental)}
