...
$-1.842$ for the incoherent superposition ($0.95$ of twice the single
tube) and $-2.997$ for the coherent gradient superposition ($1.54$ of
...
from both sides: $0.973$ ($+6.3\%$) for the incoherent and $0.862$
($-5.8\%$) for the coherent superposition on a square lattice, with
triangular-lattice values $+6.1\%$ and $-7.8\%$. Epistemic status:
